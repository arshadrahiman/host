var tns = function() {
    ...
    var B = !1;
    try {
        var S = Object.defineProperty({}, "passive", { get: function() { B = !0 } });
    ...
    var R = function(t) {
        ...
        var I, P, z, W, F, q, j, V = b.tC ? r(b.tC) : o(b, "tC", function() {
                ...
                try {
                    for (var r, o = "(10px * 10)", l = ["calc" + o, "-moz-calc" + o, "-webkit-calc" + o], f = 0; f < 3; f++)
                        if (r = l[f], i.style.width = r, 100 === i.offsetWidth) { a = r.replace(o, ""); break }
                } catch (t) {}
        ...
        if (et.forEach((function(e) {
            ...
            if (rt || function t(e) { for (var n in e) rt || ("slideBy" === n && (e[n] = "page"), "edgePadding" === n && (e[n] = !1), "autoHeight" === n && (e[n] = !1)), "responsive" === n && t(e[n]) }(t), !rt) {
            ...
            var Et, Nt, At, Lt, Bt, St, Ot, Dt = t.autoWidth,
                ...
                fe = "",
                de = "",
                ve = Ht ? function() { return Pt && !Gt ? wt - 1 : Math.ceil(-le / (Ht + Rt)) } : Dt ? function() {
                    for (var t = oe; t--;)
                        if (Et[t] >= -le) return t
                } : function() { return Pt && rt && !Gt ? wt - 1 : Gt || rt ? Math.max(0, oe - Math.ceil(zt)) : oe - 1 },
                pe = Hn(Fn("startIndex")),
                he = pe,
                me = (Dn(), 0),
                ye = Dt ? null : ve(),
            ...
            Dt || On(Ne || Be), X && (ce = X, fe = "translate", Y ? (fe += ht ? "3d(" : "3d(0px, ", de = ht ? ", 0px, 0px)" : ", 0px)") : (fe += ht ? "X(" : "Y(", de = ")")), rt && (gt.className = gt.className.replace("tns-vpfix", "")),
                function() {
                    ...
                    if (xt.insertBefore(mt, gt), yt.appendChild(gt), v(Ct, (function(t, e) { m(t, "tns-item"), t.id || (t.id = Ee + "-item" + e), !rt && dt && m(t, dt), C(t, { "aria-hidden": "true", tabindex: "-1" }) })), re) {
            ...
            var Bn = Gt ? rt ? function() {
                    ...
                    if (ye < pe)
                        ...
                        for (; pe <= ye - wt;) pe += wt
                } : function() { pe = Math.max(me, Math.min(ye, pe)) },
                Sn = rt ? function() {
                    var t, e, n, i, a, r, o, u, l, s, c;
                    Ai(gt, ""), K || !jt ? (Di(), jt && N(gt) || Ii()) : (t = gt, e = ce, n = fe, i = de, a = Si(), r = jt, o = Ii, u = Math.min(r, 10), l = 0 <= a.indexOf("%") ? "%" : "px", a = a.replace(l, ""), s = Number(t.style[e].replace(n, "").replace(i, "").replace(l, "")), c = (a - s) / r * u, setTimeout((function a() { r -= u, s += c, t.style[e] = n + s + l + i, 0 < r ? setTimeout(a, u) : o() }), u)), ht || ta()
                } : function() {
                    ae = [];
                    var t = {};
            ...
            return {
                ...
                events: Me,
                goTo: Pi,
                play: function() { _t && !hn && (ji(), yn = !1) },
                pause: function() { hn && (Vi(), yn = !0) },
                isOn: Tt,
                ...
                rebuild: function() { return R(a(t, nt)) }
            }
        }
        ...
        function Kn() {
            if (Wn("autoHeight") || Dt || !ht) {
                ...
                })), e((function() { hi(M(t), (function() { Nt = !0 })) })), !Dt && ht && (t = vi(pe, Math.min(pe + zt - 1, oe - 1))), ie ? Jn() : e((function() { hi(M(t), Jn) }))
            } else rt && Oi(), _n(), Zn()
        }
        ...
        function _n() {
            if (Ci(), mt.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + li() + "</span>  of " + wt + "</div>"), At = mt.querySelector(".tns-liveregion .current"), qe) {
                var e = _t ? "stop" : "start";
                // this comented section to hide start stop button in Testimonial header-Ar
                // bn ? C(bn, { "data-action": e }) : t.autoplayButtonOutput && (mt.insertAdjacentHTML(Pn(t.autoplayPosition), '<button data-action="' + e + '">' + wn[0] + e + wn[1] + $t[0] + "</button>"), bn = mt.querySelector("[data-action]")), bn && D(bn, { click: Gi }), _t && (ji(), te && D(gt, He), ee && D(gt, ke))
            }
            if (We) {
                if (an) C(an, { "aria-label": "Carousel Pagination" }), v(nn = an.children, (function(t, e) { C(t, { "data-nav": e, tabindex: "-1", "aria-label": dn + (e + 1), "aria-controls": Ee }) }));
                else {
        ...
        function ti(e) {
            if (Tt) {
                ...
                if ((u || Ht && !Dt) && (on = ea(), na()), (o = pe !== L) ? (Me.emit("indexChanged", ia()), r = !0) : u ? o || mi() : (Ht || Dt) && (ci(), Ci(), ui()), u && !rt && function() {
                        ...
                        setTimeout((function() { v(Ct, (function(t) { y(t, "tns-moving") })) }), 300)
                    }(), !Ne && !Be) {
        ...
        function si(t) {
            null == t && (t = Si());
            var e, n, i, a = pe;
            if (Pt || kt ? (Dt || Ht) && (n = -(parseFloat(t) + kt), i = n + It + 2 * kt) : Dt && (n = Et[pe], i = n + It), Dt) Et.forEach((function(t, r) { r < oe && ((Pt || kt) && t <= n + .5 && (a = r), .5 <= i - t && (e = r)) }));
            else {
                if (Ht) {
                    var r = Ht + Rt;
        ...
        function ci() {
            ie && !Ne && vi.apply(null, si()).forEach((function(t) {
                if (!h(t, Qe)) {
                    var e = {};
                    e[Z] = function(t) { t.stopPropagation() }, D(t, e), D(t, Xe), t.src = x(t, "data-src");
        ...
        function Zi(t) {
            if (An) {
                ...
                Nn.x = n.clientX, Nn.y = n.clientY, rt ? Tn || (Tn = e((function() {
                    ! function t(n) {
                        if (be) {
                            if (i(Tn), An && (Tn = e((function() { t(n) }))), "?" === be && (be = Ui()), be) {
                                !Ye && Ki(n) && (Ye = !0);
                                try { n.type && Me.emit(Ki(n) ? "touchMove" : "dragMove", ia(n)) } catch (t) {}
                                var a = Mn,
                                    r = Ln(Nn, En);
